...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome, you can say update trello or end my day';
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'You can say update trello to me! How can I help?';
